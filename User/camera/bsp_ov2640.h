...
//#define CAMERA_FRAME_BUFFER     0xD02EE000
...
void OV2640_DMA_Config(void);
void OV2640_DMA_M2M_Config(uint32_t v_Addr,uint32_t lcd_Addr,uint32_t DMA_BufferSize);
...
void I2Cx_Error_Handle(I2C_HandleTypeDef *i2c_handler);
