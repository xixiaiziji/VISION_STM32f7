...
#define RGB565   LTDC_PIXEL_FORMAT_RGB565

#define ARGB8888 LTDC_PIXEL_FORMAT_ARGB8888
typedef struct 
{ 
  uint32_t TextColor; 
  uint32_t BackColor;  
...
/* LCD Frame Buffer address */
//#define CAMERA_FRAME_BUFFER             0xD002EE00
#define LCD_FRAME_BUFFER_LAYER0           LCD_FB_START_ADDRESS
#define LCD_FRAME_BUFFER_LAYER1           LCD_FB_START_ADDRESS + lcd_width*lcd_height*2
#define IMAGE_FRAME_BUFFER                0xD0300000
#define IMGN_FRAME_BUFFER                 0xD0400000

//#define CONVERTED_FRAME_BUFFER          0xD03A9800
