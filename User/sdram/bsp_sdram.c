...
{		
    ...
    /*地址信号线*/
    FMC_A0_GPIO_CLK_ENABLE();    FMC_A1_GPIO_CLK_ENABLE();    FMC_A2_GPIO_CLK_ENABLE();
    FMC_A3_GPIO_CLK_ENABLE();    FMC_A4_GPIO_CLK_ENABLE();    FMC_A5_GPIO_CLK_ENABLE();
    FMC_A6_GPIO_CLK_ENABLE();    FMC_A7_GPIO_CLK_ENABLE();    FMC_A8_GPIO_CLK_ENABLE();
    FMC_A9_GPIO_CLK_ENABLE();    FMC_A10_GPIO_CLK_ENABLE();   FMC_A11_GPIO_CLK_ENABLE(); 
    /*数据信号线*/
    FMC_D0_GPIO_CLK_ENABLE();    FMC_D1_GPIO_CLK_ENABLE();    FMC_D2_GPIO_CLK_ENABLE(); 
    FMC_D3_GPIO_CLK_ENABLE();    FMC_D4_GPIO_CLK_ENABLE();    FMC_D5_GPIO_CLK_ENABLE();
    FMC_D6_GPIO_CLK_ENABLE();    FMC_D7_GPIO_CLK_ENABLE();    FMC_D8_GPIO_CLK_ENABLE();
    FMC_D9_GPIO_CLK_ENABLE();    FMC_D10_GPIO_CLK_ENABLE();   FMC_D11_GPIO_CLK_ENABLE();
    FMC_D12_GPIO_CLK_ENABLE();   FMC_D13_GPIO_CLK_ENABLE();   FMC_D14_GPIO_CLK_ENABLE();
    FMC_D15_GPIO_CLK_ENABLE();  
    /*控制信号线*/
    FMC_CS_GPIO_CLK_ENABLE();    FMC_BA0_GPIO_CLK_ENABLE();   FMC_BA1_GPIO_CLK_ENABLE();
    FMC_WE_GPIO_CLK_ENABLE();    FMC_RAS_GPIO_CLK_ENABLE();   FMC_CAS_GPIO_CLK_ENABLE();
    FMC_CLK_GPIO_CLK_ENABLE();   FMC_CKE_GPIO_CLK_ENABLE();   FMC_UDQM_GPIO_CLK_ENABLE();
    FMC_LDQM_GPIO_CLK_ENABLE();
